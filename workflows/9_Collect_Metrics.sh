...
do
    ...
    python /workspaces/src/make_predictions.py $filtered_noise_dataset_path -tmp $trained_model_path -pdp $prediction_data_path > $metrics_root_path/filtered_noise/metric_$i.txt
