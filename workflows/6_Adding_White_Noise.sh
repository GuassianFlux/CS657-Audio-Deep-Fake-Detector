...
python /workspaces/src/make_noise_dataset.py $real_dataset_path $real_white_noise_dataset_path --snr 15 --type white

# Add white noise to fake data
python /workspaces/src/make_noise_dataset.py $fake_dataset_path $fake_white_noise_dataset_path --snr 15 --type white