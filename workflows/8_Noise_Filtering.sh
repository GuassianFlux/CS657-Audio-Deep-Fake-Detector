...
python /workspaces/src/filter_noise_dataset.py $real_white_noise_dataset_path $real_filtered_noise_dir 

# Filter noise for fake data
python /workspaces/src/filter_noise_dataset.py $fake_white_noise_dataset_path $fake_filtered_noise_dir 